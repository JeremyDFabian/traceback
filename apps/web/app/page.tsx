...
export default function Page() {
  ...
  return <main className="app-shell">
    <nav className="topbar"><button className="brand" onClick={() => setScreen("setup")} aria-label="Traceback home"><img src="/traceback-logo.png" alt="Traceback" /></button><div className="nav-steps"><span className={screen === "setup" ? "active" : ""}>Set up</span><span className={screen === "editor" ? "active" : ""}>Verify</span><span className={["trace", "cards"].includes(screen) ? "active" : ""}>Trace</span></div><span className="session-status"><i /> Session saved</span></nav>
